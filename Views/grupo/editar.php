                    ...
                    <div class="panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-star"></i> Editar grupo
                            </h3>
                        ...
                        <div class="panel-body">
                            <form id="form-validation"  action="?c=grupo&a=Editar" method="post" 
                            enctype="multipart/form-data" class="form-horizontal">

                                 <input type="hidden" name="grupoId" value="<?php echo $grupo->grupoId; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        class="form-control" value="<?php echo $grupo->nombreGrupo; ?>"
                                               placeholder="Introduce un nombre al grupo" required="required">
                                    </div>
                                </div>

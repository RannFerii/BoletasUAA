                    ...
                    <div class="panel ">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-star"></i> Planes de Etudios
                            </h3>
                        ...
                        <div class="panel-body">
                            <form id="form-validation"  action="?c=plan_estudio&a=Guardar" method="post" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        class="form-control" value="<?php echo $plan_estudio->añoPlanEstudios; ?>"
                                               placeholder="Introduce un año para el plan de estudio" required="required">
                                    </div>
                                </div>
                                <div class="form-group">

...
elixir(function (mix) {
    ...
    //jstree
    mix.copy(paths.jstree + 'themes/default/style.min.css', destVendors + 'jstree/css');
    mix.copy(paths.jstree + 'themes/default/32px.png', destVendors + 'jstree/css');
    mix.copy(paths.jstree + 'themes/default/40px.png', destVendors + 'jstree/css');
    mix.copy(paths.jstree + 'themes/default/throbber.gif', destVendors + 'jstree/css');
